...
class CreateMailoraTables extends Migration
{
    public function up(): void
    {
        ...
        $this->forge->addField(['id'=>['type'=>'INT','unsigned'=>true,'auto_increment'=>true], 'workspace_id'=>['type'=>'INT','unsigned'=>true], 'name'=>['type'=>'VARCHAR','constraint'=>150], 'form_type'=>['type'=>'VARCHAR','constraint'=>30,'default'=>'embedded'], 'slug'=>['type'=>'VARCHAR','constraint'=>150], 'headline'=>['type'=>'VARCHAR','constraint'=>190], 'fields'=>['type'=>'TEXT'], 'status'=>['type'=>'VARCHAR','constraint'=>20,'default'=>'draft'], 'design_style'=>['type'=>'VARCHAR','constraint'=>40,'default'=>'classic'], 'background_color'=>['type'=>'VARCHAR','constraint'=>10,'default'=>'#ffffff'], 'accent_color'=>['type'=>'VARCHAR','constraint'=>10,'default'=>'#44B89D'], 'parallax'=>['type'=>'TINYINT','default'=>0], 'submissions'=>['type'=>'INT','default'=>0], 'created_at'=>['type'=>'DATETIME','null'=>true], 'updated_at'=>['type'=>'DATETIME','null'=>true]]);
        $this->forge->addKey('id', true); $this->forge->addUniqueKey(['workspace_id','slug']); $this->forge->createTable('forms');

        $this->forge->addField(['id'=>['type'=>'INT','unsigned'=>true,'auto_increment'=>true], 'workspace_id'=>['type'=>'INT','unsigned'=>true], 'name'=>['type'=>'VARCHAR','constraint'=>150], 'trigger_type'=>['type'=>'VARCHAR','constraint'=>40], 'trigger_event'=>['type'=>'VARCHAR','constraint'=>120,'null'=>true], 'flow_action'=>['type'=>'VARCHAR','constraint'=>40,'default'=>'send_email'], 'delay_minutes'=>['type'=>'INT','default'=>0], 'subject'=>['type'=>'VARCHAR','constraint'=>190], 'content_html'=>['type'=>'TEXT'], 'webhook_url'=>['type'=>'VARCHAR','constraint'=>255,'null'=>true], 'webhook_method'=>['type'=>'VARCHAR','constraint'=>10,'default'=>'POST'], 'webhook_payload'=>['type'=>'TEXT','null'=>true], 'status'=>['type'=>'VARCHAR','constraint'=>20','default'=>'paused'], 'created_at'=>['type'=>'DATETIME','null'=>true], 'updated_at'=>['type'=>'DATETIME','null'=>true]]);
