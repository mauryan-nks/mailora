...
class CampaignModel extends Model
{
    ...
    protected $allowedFields=['workspace_id','name','subject','preview_text','from_name','from_email','content_html','content_text','editor_type','status','segment_id','scheduled_at','timezone','sent_at'];
